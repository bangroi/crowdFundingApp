  ...
  methods: {
    go: function go() {
      ...
      axios.get(url).then(function (response) {
        ...
        var _errorconsole$log = errorconsole.log(responses),
            response = _errorconsole$log.response;
      });
    }
  }
});
    ...
    [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("v-pagination", {
            attrs: { length: _vm.lengthPage, "total-visible": 1 },
            on: { input: _vm.go },
            model: {
              value: _vm.page,
              callback: function($$v) {
