...
<v-app>
    ...
    <v-navigation-drawer app v-model="drawer">
        ...
        <v-list>
            ...
            <v-list-item-avatar>
                <v-img src="https://www.flaticon.com/svg/static/icons/svg/456/456212.svg"></v-img>
            </v-list-item-avatar>
            <v-list-item-content>
...
<!--header -->
    <v-app-bar app color="pink" dark v-if="isHome">
    ...
    <v-btn icon>
        <v-badge color="green" overlap v-if="transactions>0">
    ...
    <v-app-bar app color="pink" dark v-else>
        <v-btn class="ma-4" icon @click.stop="$router.go(-1)">
            <v-icon>mdi-arrow-left-circle</v-icon>
            <v-card-text> Back</v-card-text>
        </v-btn>
        <v-spacer></v-spacer>
